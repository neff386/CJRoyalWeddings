...
$from = new SendGrid\Email("Royal Weddings", "day900@aol.com");
...
$email_body = new SendGrid\Content("text/html","You have received a new message from your website contact form.\n\n"."Here are the details:\n\nName: $name\n\nEmail: $email_address\n\nPhone: $phone\n\nMessage:\n$message");
$headers = "From: noreply@royalweddings.com\n"; // This is the email address the generated message will be from. We recommend using something like noreply@yourdomain.com.
$headers .= "Reply-To: $email_address";  
$mail = SendGrid\Mail($from, $headers, $to, $email_body); 

$apiKey = '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';
